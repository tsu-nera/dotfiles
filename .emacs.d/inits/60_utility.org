...
** elscreen-wl
 ...
 #+begin_src emacs-lisp
(when windows-p (require 'elscreen-wl))
#+end_src
...
家では wanderlust はあまりつかわないから, windows 環境だけで利用する.
...
** Dired でカレントディレクトリを取得
  ...
  - https://gist.github.com/tsu-nera/41e735eb8883cfcef5d7
...
(with-eval-after-load "eww"
  (use-package eww-lnum
    :commnds (eww-lnum-follow eww-lnum-universal)
    :init
