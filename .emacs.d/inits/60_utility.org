...
** eww
   ...
   最新版を emacs repo からとってきて, eww.el を local directory においてる.
   ...
   見にくいときは, R eww-readable を!
   
#+begin_src emacs-lisp
(use-package eww
  :commands (eww-disable-images eww-search)
  :bind (("C-q <C-return>" . eww) ("C-x g g" . eww-search))
  :config
